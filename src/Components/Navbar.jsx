...
const Navbar = () => {
  ...
  return (
    <>
          ...
          <nav className={`w-full  overflow-x-hidden fixed  z-10 ${isScrolled  ? "bg-white shadow-xl": "bg-transparent"}`} >
            <div className='container mx-auto lg:px-28 md:px-2 px-4 py-4 md:py-2 flex flex-row justify-between items-center'>
                   <img src={logo} className="size-20"/>
                        ...
                        {toggle ? (
                          ...
                          :(<CgMenuLeft onClick={() => handleToggle ()} className="lg:hidden md:hidden flex size-8 text-[#6A4028] z-30" />)
                        }
